import AddTodo from "../js/components/add-todo.js";
...
export default class View {
  constructor() {
    ...
    this.filters.onClic((filters) => this.filter(filters));
  ...
  filter(filters) {
    ...
    const [, ...rows] = this.table.getElementsByTagName("tr"); //para no tomar el primer elemento
    for (const row of rows) {
      const [title, description, completed] = row.children;
      let isShouldHide = false;
      ...
      console.log(title, isShouldHide, row);
    }
  }
}
